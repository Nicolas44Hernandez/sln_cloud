...
class InferenceInputSchema(Schema):
    ...
    box_tx_Mbps_lag1 = Float(required=True)
    box_tx_Mbps_lag2 = Float(required=True)
    box_tx_Mbps_lag3 = Float(required=True)
    box_tx_Mbps_avg3 = Float(required=True)
    box_tx_Mbps_avg5 = Float(required=True)
    box_tx_Mbps_avg7 = Float(required=True)
    box_rx_Mbps = Float(required=True)
    box_rx_Mbps_lag1 = Float(required=True)
    box_rx_Mbps_lag2 = Float(required=True)
    box_rx_Mbps_lag3 = Float(required=True)
    box_rx_Mbps_avg3 = Float(required=True)
    box_rx_Mbps_avg5 = Float(required=True)
    box_rx_Mbps_avg7 = Float(required=True)
    box_tx_err_pps = Float(required=True)
    box_tx_ber = Float(required=True)
    ...
    signalStrength_avg3 = Float(required=True)
    signalStrength_avg5 = Float(required=True)
    signalStrength_avg7 = Float(required=True)
    signalStrength_avg10 = Float(required=True)
    ...
    tx_Mbps_lag5 = Float(required=True)
    tx_Mbps_lag7 = Float(required=True)
    tx_Mbps_avg3 = Float(required=True)
    tx_Mbps_avg5 = Float(required=True)
    tx_Mbps_avg7 = Float(required=True)
    tx_Mbps_avg10 = Float(required=True)
